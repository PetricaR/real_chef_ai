...
6. If no recipe data → Ask user: "Pentru a crea tutorialul vizual, am nevoie de datele rețetei. Te rog să creezi mai întâi o rețetă sau să îmi transmiți JSON-ul cu rețeta."
